    ...
    public WineD3DConfigDialog(final View anchor) {
        ...
        setOnConfirmCallback(new Runnable() { // from class: com.winlator.contentdialog.WineD3DConfigDialog$$ExternalSyntheticLambda0
            ...
            public final void run() {
                WineD3DConfigDialog.lambda_new_0(sVersion, cbCSMT, sDDrawWrapper, sRenderer, sGPUName, sOffscreenRenderingMode, cbStrictShaderMath, sVideoMemorySize, anchor);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_new_0(Spinner sVersion, CheckBox cbCSMT, Spinner sDDrawWrapper, Spinner sRenderer, Spinner sGPUName, Spinner sOffscreenRenderingMode, CheckBox cbStrictShaderMath, Spinner sVideoMemorySize, View anchor) {
