...
public class ActiveWindowsDialog extends ContentDialog {
    ...
    public ActiveWindowsDialog(final XServerDisplayActivity activity) {
        ...
        showDesktopButton.setOnClickListener(view -> lambda_new_0(activity, view));
        ArrayList<Window> windows = collectActiveWindows();
        loadWindowViews(windows);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_new_0(XServerDisplayActivity activity, View v) {
    ...
    private void loadWindowViews(ArrayList<Window> windows) {
        ...
        while (i >= 0) {
            ...
            if (!window.isIconic()) {
                ...
                renderer.takeWindowScreenshot(content, new Callback() { // from class: com.winlator.contentdialog.ActiveWindowsDialog$$ExternalSyntheticLambda2
                    ...
                    public final void call(Object obj) {
                        ActiveWindowsDialog.lambda_loadWindowViews_2(ivWindow, (Bitmap) obj);
                    }
                });
                z2 = false;
            } else {
            ...
            ivWindow.setOnClickListener(view -> lambda_loadWindowViews_3(window, view));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadWindowViews_2(final ImageView ivWindow, final Bitmap bitmap) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadWindowViews_3(Window window, View v) {
