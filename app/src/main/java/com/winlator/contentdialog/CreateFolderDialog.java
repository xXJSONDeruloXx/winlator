...
public class CreateFolderDialog extends ContentDialog {
    ...
    public CreateFolderDialog(ContainerManager manager) {
        ...
        setOnConfirmCallback(() -> lambda_new_0(etName, containers, sContainer));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_new_0(EditText etName, ArrayList containers, Spinner sContainer) {
