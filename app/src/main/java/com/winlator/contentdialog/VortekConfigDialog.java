    ...
    public VortekConfigDialog(final View anchor) {
        ...
        setOnConfirmCallback(new Runnable() { // from class: com.winlator.contentdialog.VortekConfigDialog$$ExternalSyntheticLambda0
            ...
            public final void run() {
                VortekConfigDialog.lambda_new_0(sAdrenotoolsDriver, sVkMaxVersion, sMaxDeviceMemory, sImageCacheSize, sResourceMemoryType, mscbExposedExtensions, deviceExtensions, anchor);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_new_0(Spinner sAdrenotoolsDriver, Spinner sVkMaxVersion, Spinner sMaxDeviceMemory, Spinner sImageCacheSize, Spinner sResourceMemoryType, MultiSelectionComboBox mscbExposedExtensions, String[] deviceExtensions, View anchor) {
