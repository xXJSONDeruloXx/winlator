    ...
    public AudioDriverConfigDialog(final View anchor) {
        ...
        setOnConfirmCallback(new Runnable() { // from class: com.winlator.contentdialog.AudioDriverConfigDialog$$ExternalSyntheticLambda0
            ...
            public final void run() {
                AudioDriverConfigDialog.lambda_new_0(sPerformanceMode, sbVolume, sbLatencyMillis, anchor);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_new_0(Spinner sPerformanceMode, SeekBar sbVolume, SeekBar sbLatencyMillis, View anchor) {
