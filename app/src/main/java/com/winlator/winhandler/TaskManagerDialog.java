...
public class TaskManagerDialog extends ContentDialog implements OnGetProcessInfoListener {
    ...
    static class Panel {
        ...
        public void setPopupMenuItems(ArrayList<String> items) {
            if (this.popupMenu == null) {
                ...
                menuButton.setOnClickListener(view -> lambda_setPopupMenuItems_0(view));
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda_setPopupMenuItems_0(View v) {
            this.popupMenu.show();
        }
    }
    ...
    public TaskManagerDialog(final XServerDisplayActivity activity) {
        ...
        cancelButton.setOnClickListener(view -> lambda_new_1(activity, view));
        setOnDismissListener(dialogInterface -> lambda_new_2(activity, dialogInterface));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_new_1(final XServerDisplayActivity activity, View v) {
        dismiss();
        ContentDialog.prompt(activity, R.string.new_task, "taskmgr.exe", new Callback() { // from class: com.winlator.winhandler.TaskManagerDialog$$ExternalSyntheticLambda4
            ...
            public final void call(Object obj) {
                TaskManagerDialog.lambda_new_0(activity, (String) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_new_0(XServerDisplayActivity activity, String command) {
        activity.getWinHandler().exec(command);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_new_2(XServerDisplayActivity activity, DialogInterface dialog) {
    ...
    public void lambda_onGetProcessInfo_6(View anchorView, final ProcessInfo processInfo) {
        ...
        listItemMenu.setOnMenuItemClickListener(menuItem -> lambda_showListItemMenu_4(processInfo, menuItem));
        listItemMenu.show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda_showListItemMenu_4(final ProcessInfo processInfo, MenuItem menuItem) {
        int itemId = menuItem.getItemId();
        final WinHandler winHandler = this.activity.getWinHandler();
        if (itemId == R.id.menu_item_bring_to_front) {
                ...
                ContentDialog.confirm(this.activity, R.string.do_you_want_to_end_this_process, new Runnable() { // from class: com.winlator.winhandler.TaskManagerDialog$$ExternalSyntheticLambda7
                    ...
                    public final void run() {
                        TaskManagerDialog.lambda_showListItemMenu_3(winHandler, processInfo);
                    }
                });
        } else if (itemId == R.id.menu_item_process_affinity) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_showListItemMenu_3(WinHandler winHandler, ProcessInfo processInfo) {
    ...
    private void showProcessorAffinityDialog(final ProcessInfo processInfo) {
        ...
        dialog.setOnConfirmCallback(() -> lambda_showProcessorAffinityDialog_5(processInfo, cpuListView));
        dialog.show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_showProcessorAffinityDialog_5(ProcessInfo processInfo, CPUListView cpuListView) {
    ...
    public void onGetProcessInfo(final int index, final int numProcesses, final ProcessInfo processInfo) {
        this.activity.runOnUiThread(() -> lambda_onGetProcessInfo_7(numProcesses, index, processInfo));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_onGetProcessInfo_7(int numProcesses, int index, final ProcessInfo processInfo) {
        Bitmap icon;
        synchronized (this.lock) {
            LinearLayout container = (LinearLayout) findViewById(R.id.LLProcessList);
            ...
            itemView.findViewById(R.id.BTMenu).setOnClickListener(view -> lambda_onGetProcessInfo_6(view, processInfo));
    ...
    private void updateMemoryPanel() {
        ...
        byte memUsagePercent = (byte) (((double) usedMem / memoryInfo.totalMem) * 100.0d);
