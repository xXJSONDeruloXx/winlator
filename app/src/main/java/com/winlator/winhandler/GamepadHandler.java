...
public class GamepadHandler {
    ...
    public void handleGetGamepadRequest(final int port) {
        ...
        this.winHandler.addAction(() -> lambda_handleGetGamepadRequest_0(isXInput, port, forceDisable));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_handleGetGamepadRequest_0(boolean isXInput, int port, boolean[] forceDisable) {
        if (isXInput) {
    ...
    public void sendGamepadState(GamepadSlot gamepadSlot) {
        ...
        for (final GamepadClient client : this.gamepadClients) {
            if (client.enabledSlots[slot]) {
                this.winHandler.addAction(() -> lambda_sendGamepadState_1(client, slot, state));
            }
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_sendGamepadState_1(GamepadClient client, byte slot, GamepadState state) {
