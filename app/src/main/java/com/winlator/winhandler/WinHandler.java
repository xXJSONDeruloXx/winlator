...
public class WinHandler {
    ...
    public void exec(String command) {
        ...
        addAction(() -> lambda_exec_0(filename, parameters));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_exec_0(String filename, String parameters) {
    ...
    public void killProcess(final String processName, final int pid) {
        addAction(() -> lambda_killProcess_1(processName, pid));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_killProcess_1(String processName, int pid) {
        this.sendData.rewind();
    ...
    public void listProcesses() {
        addAction(() -> lambda_listProcesses_2());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_listProcesses_2() {
    ...
    public void setProcessAffinity(final String processName, final int affinityMask) {
        addAction(() -> lambda_setProcessAffinity_3(processName, affinityMask));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_setProcessAffinity_3(String processName, int affinityMask) {
        byte[] bytes = processName.getBytes();
        this.sendData.rewind();
    ...
    public void setProcessAffinity(final int pid, final int affinityMask) {
        addAction(() -> lambda_setProcessAffinity_4(pid, affinityMask));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_setProcessAffinity_4(int pid, int affinityMask) {
        this.sendData.rewind();
        this.sendData.put((byte) 6);
    ...
    public void mouseEvent(final int flags, final int dx, final int dy, final int wheelDelta) {
        if (this.initReceived) {
            addAction(() -> lambda_mouseEvent_5(flags, dx, dy, wheelDelta));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_mouseEvent_5(int flags, int dx, int dy, int wheelDelta) {
        this.sendData.rewind();
    ...
    public void bringToFront(final String processName, final long handle) {
        addAction(() -> lambda_bringToFront_7(processName, handle));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_bringToFront_7(String processName, long handle) {
        this.sendData.rewind();
    ...
    public void showDesktop() {
        addAction(() -> lambda_showDesktop_8());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_showDesktop_8() {
        this.sendData.rewind();
    ...
    public void setClipboardData(final String data) {
        addAction(() -> lambda_setClipboardData_9(data));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_setClipboardData_9(String data) {
        this.sendData.rewind();
    ...
    private void startSendThread() {
        Executors.newSingleThreadExecutor().execute(() -> lambda_startSendThread_10());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_startSendThread_10() {
        while (this.running) {
            synchronized (this.actions) {
    ...
    private void handleRequest(byte requestCode, int port) throws IOException {
        switch (requestCode) {
            ...
            case 16:
                ...
                if (isMidiOut) {
                    this.midiHandler.open(() -> lambda_handleRequest_11());
                    return;
                } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_handleRequest_11() {
    ...
    public void start() {
        ...
        this.running = true;
        startSendThread();
        Executors.newSingleThreadExecutor().execute(() -> lambda_start_12());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_start_12() {
        try {
