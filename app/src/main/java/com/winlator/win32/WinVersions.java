...
public abstract class WinVersions {
            ...
            if (systemRegFile.isFile()) {
                ...
                Executors.newSingleThreadExecutor().execute(new Runnable() { // from class: com.winlator.win32.WinVersions$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        WinVersions.lambda_loadSpinner_1(sWinVersion, systemRegFile, winVersions);
                    }
                });
            }
        }
    ...
    public static /* synthetic */ void lambda_loadSpinner_1(final Spinner sWinVersion, File systemRegFile, WinVersion[] winVersions) {
        ...
        try {
            ...
            sWinVersion.post(new Runnable() { // from class: com.winlator.win32.WinVersions$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    WinVersions.lambda_loadSpinner_0(sWinVersion, newPosition);
                }
            });
        } catch (Throwable th) {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadSpinner_0(Spinner sWinVersion, byte newPosition) {
