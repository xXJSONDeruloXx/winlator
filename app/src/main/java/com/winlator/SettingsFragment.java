...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.BTSoundFontTest).setOnClickListener(new View.OnClickListener() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view2) {
                SettingsFragment.lambda_onCreateView_0(context, sSoundFont, view2);
            }
        });
        ...
        cbSaveLogsToFile.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda14
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                SettingsFragment.lambda_onCreateView_1(etLogFile, compoundButton, z);
            }
        });
        ...
        lambda_loadWineVersionSpinner_13(view, sWineVersion);
        ...
        view.findViewById(R.id.BTReinstallSystemFiles).setOnClickListener(view2 -> lambda_onCreateView_3(context, view2));
        loadGamepadPlayerConfigs(view);
        view.findViewById(R.id.BTConfirm).setOnClickListener(view2 -> lambda_onCreateView_4(sSoundFont, sBox64Version, sBox64Preset, cbMoveCursorToTouchpoint, cbCapturePointerOnExternalMouse, sbCursorSpeed, sbCursorSize, cpvCursorColor, cbEnableWineDebug, sBox64Logs, cbSaveLogsToFile, sPreferredInputApi, cbOpenAndroidBrowserFromWine, cbUseAndroidClipboardOnWine, view, rgAppTheme, sLanguage, oldLCIndex, oldAppThemeId, sMIDIInputDevice, etLogFile, defaultLogPath, wineDebugChannels, view2));
        return view;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_onCreateView_0(Context context, Spinner sSoundFont, View v) {
        new SoundFontTestDialog(context, sSoundFont.getSelectedItem().toString()).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_onCreateView_1(EditText etLogFile, CompoundButton buttonView, boolean isChecked) {
        etLogFile.setVisibility(isChecked ? 0 : 8);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_onCreateView_2() {
        RootFSInstaller.install((MainActivity) getActivity());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_onCreateView_3(Context context, View v) {
        ContentDialog.confirm(context, R.string.do_you_want_to_reinstall_system_files, () -> lambda_onCreateView_2());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_onCreateView_4(Spinner sSoundFont, Spinner sBox64Version, Spinner sBox64Preset, CheckBox cbMoveCursorToTouchpoint, CheckBox cbCapturePointerOnExternalMouse, SeekBar sbCursorSpeed, SeekBar sbCursorSize, ColorPickerView cpvCursorColor, CheckBox cbEnableWineDebug, Spinner sBox64Logs, CheckBox cbSaveLogsToFile, Spinner sPreferredInputApi, CheckBox cbOpenAndroidBrowserFromWine, CheckBox cbUseAndroidClipboardOnWine, View view, RadioGroup rgAppTheme, Spinner sLanguage, int oldLCIndex, int oldAppThemeId, Spinner sMIDIInputDevice, EditText etLogFile, String defaultLogPath, ArrayList wineDebugChannels, View v) {
        String string;
    ...
    private void loadBox64PresetSpinner(View view, final Spinner sBox64Preset) {
        final Context context = getContext();
        final Runnable updateSpinner = () -> lambda_loadBox64PresetSpinner_5(sBox64Preset);
        updateSpinner.run();
        view.findViewById(R.id.BTAddBox64Preset).setOnClickListener(new View.OnClickListener() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                SettingsFragment.lambda_loadBox64PresetSpinner_6(context, updateSpinner, view2);
            }
        });
        view.findViewById(R.id.BTEditBox64Preset).setOnClickListener(new View.OnClickListener() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                SettingsFragment.lambda_loadBox64PresetSpinner_7(context, sBox64Preset, updateSpinner, view2);
            }
        });
        view.findViewById(R.id.BTDuplicateBox64Preset).setOnClickListener(new View.OnClickListener() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                SettingsFragment.lambda_loadBox64PresetSpinner_8(context, sBox64Preset, updateSpinner, view2);
            }
        });
        view.findViewById(R.id.BTRemoveBox64Preset).setOnClickListener(new View.OnClickListener() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                SettingsFragment.lambda_loadBox64PresetSpinner_10(sBox64Preset, context, updateSpinner, view2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadBox64PresetSpinner_5(Spinner sBox64Preset) {
        Box64PresetManager.loadSpinner(sBox64Preset, this.preferences.getString("box64_preset", "INTERMEDIATE"));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadBox64PresetSpinner_6(Context context, Runnable updateSpinner, View v) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadBox64PresetSpinner_7(Context context, Spinner sBox64Preset, Runnable updateSpinner, View v) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadBox64PresetSpinner_8(Context context, Spinner sBox64Preset, Runnable updateSpinner, View v) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadBox64PresetSpinner_10(Spinner sBox64Preset, final Context context, final Runnable updateSpinner, View v) {
        ...
        if (!presetId.startsWith("CUSTOM")) {
            ...
            ContentDialog.confirm(context, R.string.do_you_want_to_remove_this_preset, new Runnable() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda20
                ...
                public final void run() {
                    SettingsFragment.lambda_loadBox64PresetSpinner_9(context, presetId, updateSpinner);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadBox64PresetSpinner_9(Context context, String presetId, Runnable updateSpinner) {
    ...
    private void removeInstalledWine(WineInfo wineInfo, final Runnable onSuccess) {
        ...
        if (!wineDir.isDirectory() || !containerPatternFile.isFile()) {
            ...
            this.preloaderDialog.show(R.string.removing_wine);
            Executors.newSingleThreadExecutor().execute(() -> lambda_removeInstalledWine_11(wineDir, containerPatternFile, onSuccess, activity));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_removeInstalledWine_11(File wineDir, File containerPatternFile, Runnable onSuccess, Activity activity) {
    ...
    public void lambda_loadWineVersionSpinner_13(final View view, final Spinner sWineVersion) {
        ...
        view.findViewById(R.id.BTInstallWine).setOnClickListener(view2 -> lambda_loadWineVersionSpinner_12(view2));
        view.findViewById(R.id.BTRemoveWine).setOnClickListener(view2 -> lambda_loadWineVersionSpinner_15(wineInfos, sWineVersion, view, view2));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadWineVersionSpinner_12(View v) {
        selectWineFileForInstall();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadWineVersionSpinner_15(ArrayList wineInfos, final Spinner sWineVersion, final View view, View v) {
        final WineInfo wineInfo = (WineInfo) wineInfos.get(sWineVersion.getSelectedItemPosition());
        if (wineInfo != WineInfo.MAIN_WINE_INFO) {
            ContentDialog.confirm(getContext(), R.string.do_you_want_to_remove_this_wine_version, () -> lambda_loadWineVersionSpinner_14(wineInfo, view, sWineVersion));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadWineVersionSpinner_14(WineInfo wineInfo, final View view, final Spinner sWineVersion) {
        removeInstalledWine(wineInfo, () -> lambda_loadWineVersionSpinner_13(view, sWineVersion));
    }

    private void selectWineFileForInstall() {
        final Context context = getContext();
        this.selectWineFileCallback = obj -> lambda_selectWineFileForInstall_19(context, (Uri) obj);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_selectWineFileForInstall_19(final Context context, Uri uri) {
        this.preloaderDialog.show(R.string.preparing_installation);
        WineInstaller.extractWineFileForInstallAsync(context, uri, obj -> lambda_selectWineFileForInstall_18(context, (File) obj));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_selectWineFileForInstall_18(final Context context, File wineDir) {
        if (wineDir != null) {
            WineInstaller.findWineVersionAsync(context, wineDir, obj -> lambda_selectWineFileForInstall_17(context, (WineInfo) obj));
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_selectWineFileForInstall_17(Context context, final WineInfo wineInfo) {
        this.preloaderDialog.closeOnUiThread();
        if (wineInfo == null) {
            AppUtils.showToast(context, R.string.unable_to_install_wine);
        } else {
            getActivity().runOnUiThread(() -> lambda_selectWineFileForInstall_16(wineInfo));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: installWine, reason: merged with bridge method [inline-methods] */
    public void lambda_showWineInstallDialog_22(WineInfo wineInfo) {
        Context context = getContext();
    ...
    public void lambda_selectWineFileForInstall_16(final WineInfo wineInfo) {
        String str;
        Context context = getContext();
        ...
        FileUtils.getSizeAsync(new File(wineInfo.path), new Callback() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda19
            ...
            public final void call(Object obj) {
                SettingsFragment.lambda_showWineInstallDialog_21(totalSizeRef, etSize, (Long) obj);
            }
        });
        dialog.setOnConfirmCallback(() -> lambda_showWineInstallDialog_22(wineInfo));
        dialog.show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_showWineInstallDialog_21(final AtomicLong totalSizeRef, final EditText etSize, Long size) {
        ...
        etSize.post(new Runnable() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
                SettingsFragment.lambda_showWineInstallDialog_20(etSize, totalSizeRef);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_showWineInstallDialog_20(EditText etSize, AtomicLong totalSizeRef) {
    ...
    private void loadWineDebugChannels(final View view, final ArrayList<String> debugChannels) {
        ...
        addButton.setOnClickListener(view2 -> lambda_loadWineDebugChannels_24(context, debugChannels, view, view2));
        View resetButton = itemView.findViewById(R.id.BTReset);
        resetButton.setVisibility(0);
        resetButton.setOnClickListener(view2 -> lambda_loadWineDebugChannels_25(debugChannels, view, view2));
        ...
        while (i2 < debugChannels.size()) {
            ...
            final int index = i2;
            itemView2.findViewById(R.id.BTRemove).setOnClickListener(view2 -> lambda_loadWineDebugChannels_26(debugChannels, index, view, view2));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadWineDebugChannels_24(Context context, final ArrayList debugChannels, final View view, View v) {
        ...
        ContentDialog.showSelectionList(context, R.string.wine_debug_channel, items, true, (Callback<ArrayList<Integer>>) obj -> lambda_loadWineDebugChannels_23(debugChannels, items, view, (ArrayList) obj));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadWineDebugChannels_23(ArrayList debugChannels, String[] items, View view, ArrayList selectedPositions) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadWineDebugChannels_25(ArrayList debugChannels, View view, View v) {
        debugChannels.clear();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_loadWineDebugChannels_26(ArrayList debugChannels, int index, View view, View v) {
    ...
    private void loadGamepadPlayerConfigs(View view) {
        ...
        view.findViewById(R.id.BTResetGamepadPlayerConfigs).setOnClickListener(new View.OnClickListener() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                SettingsFragment.lambda_loadGamepadPlayerConfigs_28(container, view2);
            }
        });
        for (int i = 0; i < container.getChildCount(); i++) {
            ...
            child.setOnClickListener(new View.OnClickListener() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    SettingsFragment.lambda_loadGamepadPlayerConfigs_29(child, slot, view2);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadGamepadPlayerConfigs_28(final LinearLayout container, View v) {
        ContentDialog.confirm(v.getContext(), R.string.do_you_want_to_reset_configurations, new Runnable() { // from class: com.winlator.SettingsFragment$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
                SettingsFragment.lambda_loadGamepadPlayerConfigs_27(container);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadGamepadPlayerConfigs_27(LinearLayout container) {
        for (int i = 0; i < container.getChildCount(); i++) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_loadGamepadPlayerConfigs_29(View child, byte slot, View v) {
