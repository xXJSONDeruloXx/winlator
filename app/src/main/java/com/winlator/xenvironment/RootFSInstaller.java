...
public abstract class RootFSInstaller {
    ...
    public static void install(final MainActivity activity) {
        ...
        Executors.newSingleThreadExecutor().execute(new Runnable() { // from class: com.winlator.xenvironment.RootFSInstaller$$ExternalSyntheticLambda2
            ...
            public final void run() {
                RootFSInstaller.lambda_install_2(rootDir, activity, dialog, rootFS);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda_install_2(File rootDir, final MainActivity activity, final DownloadProgressDialog dialog, RootFS rootFS) {
        ...
        boolean success = TarCompressorUtils.extract(type, activity, "rootfs.tzst", rootDir, new TarCompressorUtils.OnExtractFileListener() { // from class: com.winlator.xenvironment.RootFSInstaller$$ExternalSyntheticLambda0
            ...
            public final File onExtractFile(File file, long j) {
                return RootFSInstaller.lambda_install_1(totalSizeRef, contentLength, activity, dialog, file, j);
            }
        });
        if (success) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ File lambda_install_1(AtomicLong totalSizeRef, long contentLength, MainActivity activity, final DownloadProgressDialog dialog, File file, long size) {
        if (size > 0) {
