...
public class GuestProgramLauncherComponent extends EnvironmentComponent {
    ...
    private int execGuestProgram() {
        ...
        return ProcessHelper.exec(command, envVars, rootDir, obj -> lambda_execGuestProgram_0((Integer) obj));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda_execGuestProgram_0(Integer status) {
        synchronized (lock) {
            pid = -1;
        }
