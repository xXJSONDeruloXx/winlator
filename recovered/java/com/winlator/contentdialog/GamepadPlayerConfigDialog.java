...
public class GamepadPlayerConfigDialog extends ContentDialog {
    ...
    public GamepadPlayerConfigDialog(final View anchor, byte number) {
        ...
        rgMode.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.winlator.contentdialog.GamepadPlayerConfigDialog$$ExternalSyntheticLambda0
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public final void onCheckedChanged(RadioGroup radioGroup, int i) {
                this.f$0.lambda$new$0(sSource, selectedValue, radioGroup, i);
            }
        });
        ...
        setOnConfirmCallback(new Runnable() { // from class: com.winlator.contentdialog.GamepadPlayerConfigDialog$$ExternalSyntheticLambda1
            ...
            public final void run() {
                GamepadPlayerConfigDialog.lambda$new$1(rgMode, sSource, cbEnableVibration, anchor);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$0(Spinner sSource, String selectedValue, RadioGroup radioGroup, int checkedId) {
        loadSourceSpinner(checkedId == R.id.RBExternalController ? (byte) 0 : (byte) 1, sSource, selectedValue);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$new$1(RadioGroup rgMode, Spinner sSource, CheckBox cbEnableVibration, View anchor) {
