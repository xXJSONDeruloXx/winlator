    ...
    public DXVKConfigDialog(String graphicsDriver, final View anchor) {
        ...
        setOnConfirmCallback(new Runnable() { // from class: com.winlator.contentdialog.DXVKConfigDialog$$ExternalSyntheticLambda0
            ...
            public final void run() {
                DXVKConfigDialog.lambda$new$0(sVersion, sFramerate, sMaxDeviceMemory, sDDrawWrapper, sCustomDevice, anchor);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$new$0(Spinner sVersion, Spinner sFramerate, Spinner sMaxDeviceMemory, Spinner sDDrawWrapper, Spinner sCustomDevice, View anchor) {
