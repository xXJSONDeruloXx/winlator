...
public class FrameRating extends FrameLayout implements Runnable {
    ...
    public /* synthetic */ void lambda$setGPUInfo$0(String gpuInfo) {
        ((TextView) this.gpuPanel.getChildAt(1)).setText(gpuInfo);
    }

    public void setGPUInfo(final String gpuInfo) {
        post(new Runnable() { // from class: com.winlator.widget.FrameRating$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setGPUInfo$0(gpuInfo);
            }
        });
    }
