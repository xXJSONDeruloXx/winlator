...
public abstract class WineInstaller {
    public static void generateWineprefix(final WineInfo wineInfo, XEnvironment environment) {
        ...
        guestProgramLauncherComponent.setTerminationCallback(new Callback() { // from class: com.winlator.core.WineInstaller$$ExternalSyntheticLambda0
            ...
            public final void call(Object obj) {
                WineInstaller.lambda$generateWineprefix$1(activity, installedWineDir, preloaderDialog, rootDir, wineInfo, (Integer) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$generateWineprefix$1(final Activity activity, final File installedWineDir, final PreloaderDialog preloaderDialog, final File rootDir, final WineInfo wineInfo, final Integer status) {
        Executors.newSingleThreadExecutor().execute(new Runnable() { // from class: com.winlator.core.WineInstaller$$ExternalSyntheticLambda4
            ...
            public final void run() {
                WineInstaller.lambda$generateWineprefix$0(status, activity, installedWineDir, preloaderDialog, rootDir, wineInfo);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$generateWineprefix$0(Integer status, Activity activity, File installedWineDir, PreloaderDialog preloaderDialog, File rootDir, WineInfo wineInfo) {
    ...
    public static void extractWineFileForInstallAsync(final Context context, final Uri uri, final Callback<File> callback) {
        Executors.newSingleThreadExecutor().execute(new Runnable() { // from class: com.winlator.core.WineInstaller$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                WineInstaller.lambda$extractWineFileForInstallAsync$2(context, uri, callback);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$extractWineFileForInstallAsync$2(Context context, Uri uri, Callback callback) {
    ...
    public static void findWineVersionAsync(Context context, File wineDir, final Callback<WineInfo> callback) {
        ...
        final Callback<String> debugCallback = new Callback() { // from class: com.winlator.core.WineInstaller$$ExternalSyntheticLambda2
            @Override // com.winlator.core.Callback
            public final void call(Object obj) {
                WineInstaller.lambda$findWineVersionAsync$3(wineInfoRef, winePath, (String) obj);
            }
        };
        ...
        guestProgramLauncherComponent.setTerminationCallback(new Callback() { // from class: com.winlator.core.WineInstaller$$ExternalSyntheticLambda1
            @Override // com.winlator.core.Callback
            public final void call(Object obj) {
                WineInstaller.lambda$findWineVersionAsync$4(callback, wineInfoRef, debugCallback, (Integer) obj);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$findWineVersionAsync$3(AtomicReference wineInfoRef, String winePath, String line) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$findWineVersionAsync$4(Callback callback, AtomicReference wineInfoRef, Callback debugCallback, Integer status) {
