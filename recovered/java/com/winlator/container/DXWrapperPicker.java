...
public class DXWrapperPicker {
        ...
        for (int i = 0; i < apiNames.length; i++) {
            ...
            if (i == 0) {
                ...
                taggedSelectionBox.setOnItemSelectedListener(new TaggedSelectionBox.OnItemSelectedListener() { // from class: com.winlator.container.DXWrapperPicker$$ExternalSyntheticLambda1
                    ...
                    public final void onItemSelected(String str) {
                        DXWrapperPicker.lambda$new$0(oldDXWrapper, taggedSelectionBox, str);
                    }
                });
            } else {
            ...
            taggedSelectionBox.setOnButtonClickListener(new TaggedSelectionBox.OnButtonClickListener() { // from class: com.winlator.container.DXWrapperPicker$$ExternalSyntheticLambda0
                ...
                public final void onClick() {
                    DXWrapperPicker.lambda$new$1(taggedSelectionBox, graphicsDriverPicker);
                }
            });
    ...
    public static /* synthetic */ void lambda$new$0(String[] oldDXWrapper, TaggedSelectionBox taggedSelectionBox, String item) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$new$1(TaggedSelectionBox taggedSelectionBox, GraphicsDriverPicker graphicsDriverPicker) {
