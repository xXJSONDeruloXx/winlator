    ...
    */
    ...
    private void handleRadialMenuClick(float x, float y) {
        ...
        if (clickedBinding2 != Binding.NONE) {
            ...
            controlElement.inputControlsView.postDelayed(new Runnable() { // from class: com.winlator.inputcontrols.ControlElement$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$handleRadialMenuClick$0(finalBinding);
                }
            }, 30L);
        }
    }
    ...
    public /* synthetic */ void lambda$handleRadialMenuClick$0(Binding finalBinding) {
