...
class ClockHandView extends View {
    ...
    public void setHandRotation(float degrees, boolean animate) {
        ...
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(((Float) animationValues.first).floatValue(), ((Float) animationValues.second).floatValue());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        boolean zHandleTouchInput = handleTouchInput(x, y, forceSelection, actionDown, actionUp) | this.changedDuringTouch;
        this.changedDuringTouch = zHandleTouchInput;
        if (zHandleTouchInput && actionUp && (onActionUpListener = this.onActionUpListener) != null) {
