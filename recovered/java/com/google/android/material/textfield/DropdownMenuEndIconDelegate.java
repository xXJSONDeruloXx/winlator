...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_above_anchor}, roundedCornersPopupBackground);
    ...
    public void addRippleEffect(AutoCompleteTextView editText) {
        ...
        int[][] states = {new int[]{R.attr.state_pressed}, new int[0]};
        if (boxBackgroundMode == 2) {
    ...
    public void setUpDropdownShowHideBehavior(final AutoCompleteTextView editText) {
        editText.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.7
        ...
        if (IS_LOLLIPOP) {
            editText.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.8
    ...
    private ValueAnimator getAlphaAnimator(int duration, float... values) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.10
